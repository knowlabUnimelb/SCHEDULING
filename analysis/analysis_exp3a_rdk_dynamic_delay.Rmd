---
title: "Experiment 3a: Dynamic RDK Direction Judgement, 4 Tasks, 500 msec Error Penalty"
...
date <- "221025"
experimentName = "ruby_dynamic" # use the index.Rmd file to track which experiment is which

#define working directories
inputdir <- "data"

# NEW 2/11/22: Reading data and variable names 
colfile       <- read.csv(paste(inputdir,"data_dictionary_ruby.csv",sep="/"), stringsAsFactors = FALSE)
datafilename = "exp3a_rdk_data_dynamic.csv"
...
# OLD
#fixed_datafilename = "210427_fixed_moving_delay_data_ruby_corrected.csv"
#random_datafilename = "210427_random_moving_delay_data_ruby_corrected.csv"
...
<!-- Datasets from `r length(repeatedIds)` subjects were excluded for completing the experiment more than once; i.e., only the first of the datasets for these subjects was retained. -->
