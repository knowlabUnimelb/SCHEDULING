---
title: "Experiment 2b: RDK Direction Judgement, Average Completion Time Label, 4 Tasks, 500 msec  Error Penalty"
...
Ruby Sternberg^1^, Ami Eidels^2^, and Daniel R. Little^1^
...
#<!-- 210804_fixed_rdk_avgtime_data.csv -->
#<!-- 210804_random_rdk_avgtime_data.csv -->

# NEW 2/11/22: 
colfile       <- read.csv(paste(inputdir,"data_dictionary_avgTime.csv",sep="/"), stringsAsFactors = FALSE)
datafilename = "exp2b_rdk_data_avgtime.csv"
...
#fixed_datafilename = "210804_fixed_rdk_avgtime_data.csv"
#random_datafilename = "210804_random_rdk_avgtime_data.csv"
...
# random 29211 --> 98840
completeSubjects = completeSubjects[!(completeSubjects$subject %in% c(98840)), ]
...
img <- readPNG("analysis/patch_selection_avg.png")
