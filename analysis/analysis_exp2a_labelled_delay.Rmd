...
After removing any participants who had less than chance accuracy on the easiest RDK indicating equipment problems or a misunderstanding of task directions, there were `r final_n$n[final_n$condition == "fixed"]` and `r final_n$n[final_n$condition == "random"]` in the fixed and random location conditions, respectively.
