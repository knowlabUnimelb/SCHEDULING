---
title: "Experiment 7b: Labelled RDK - Wordle Reward"
...
datafilename = "exp7b_rdk_reward_data.csv"
...
rawdata = rawdata[rawdata$uniqueid != 30701, ] # remove trouble maker (server cut out some trials making it impossible to know their response and screwing up the code - just drop them
...
# Some participants have only one incorrect trial for some conditions; e.g. subject 78579, deadline, very hard
# this results as a 0 for the reward rate which skews the figure
# Drop this subject's for that condition
rdk$correct[rdk$subject == 78579 & rdk$phase == "deadline" & rdk$dot_coherence == 0] = NA
